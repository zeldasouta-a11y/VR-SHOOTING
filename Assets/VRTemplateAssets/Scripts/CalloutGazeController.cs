...
namespace Unity.VRTemplate
{
    ...
    public class CalloutGazeController : MonoBehaviour
    {
        ...
        [SerializeField, Tooltip("Events fired when the Gaze Transform begins facing this nowGamePhase object")]
        UnityEvent m_FacingEntered;

        [SerializeField, Tooltip("Events fired when the Gaze Transform stops facing this nowGamePhase object")]
